    ...
    return (
        <>
            {pathname !== "/login" && (
                <Box sx={{ display: 'flex' }}>
                    <CssBaseline />
                    <AppBar className="fixed bg-blue-400" open={open}>
                        <Toolbar>
                            <IconButton
                                color="inherit"
                            ...
                            <div className="ml-auto flex items-center space-x-3">
                                ...
                                <button onClick={toggleUser} className="flex items-center">
                                    <Image
                                        ...
                                        width={40}
                                        height={40}
                                        className="rounded-full border-r-4"
                                    />
                                    <ExpandMoreIcon />
                                </button>
                                {isOpen && (
                    ...
                    <Drawer variant="permanent" open={open}>
                        ...
                        <Divider />
                        <List className='bg-blue-400 text-white'>
                            {['Trang chủ', 'Nhân viên', 'Danh sách sách', 'Lịch sử'].map(
                                (text, index) => (
                                    <ListItem key={text} disablePadding sx={{ display: 'block' }}>
                                        <Link href={getHrefByText(text)} passHref>
                                            ...
                                            >
                                                ...
                                                >
                                                    {text === 'Trang chủ' ? (
                                                        <HomeIcon sx = {{color : 'white' , opacity : 0.8}} />
                                                    ) : text === 'Nhân viên' ? (
                                                        <PersonIcon sx = {{color : 'white' , opacity : 0.8}} />
                                                    ) : text === 'Danh sách sách' ? (
                                                        <MenuBookIcon sx = {{color : 'white' , opacity : 0.8}} />
                                                    ) : text === 'Lịch sử' ? (
                                                        <WorkHistoryIcon sx = {{color : 'white' , opacity : 0.8}} />
                                                    ) : null}
                                                </ListItemIcon>
                                ...
                                <ListItem key={text} disablePadding sx={{ display: 'block' }}>
                                    <Link href={getHrefByText(text)} passHref>
                                        ...
                                        >
                                            ...
                                            >
                                                {index % 2 === 0 ? (
                                                    <ManageAccountsIcon sx = {{color : 'white' , opacity : 0.8}} />
                                                ) : (
                                                    <PictureAsPdfIcon sx = {{color : 'white' , opacity : 0.8}} />
                                                )}
                                            </ListItemIcon>
                                            <ListItemText primary={text} sx={{ opacity: open ? 1 : 0 }} />
                                        </ListItemButton>
